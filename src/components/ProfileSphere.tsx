...
export default function ProfileSphere() {
  ...
  useEffect(() => {
    ...
    // Wave-morph vertex shader + lime green fragment shader (Gunasree-style)
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          gl_FragColor = vec4(0.690, 1.0, 0.267, 0.35);
        }
      `,
    ...
    // Spring-smoothed mouse tracking (Gunasree's exact method)
    ...
    const animate = () => {
      ...
      // Feed time into wave morph
      material.uniforms.uTime.value = time;

      // Spring interpolation — smooth, laggy, interactive feel
